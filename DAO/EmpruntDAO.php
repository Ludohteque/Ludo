...
class EmpruntDAO extends DAO {
    ...
    public function find($id) {
        ...
        $emprunt = new Emprunt($d["id_emprunts"], $d["date_emprunts"], $d["date_remise"], $user, $exemplaire);
        return $emprunt;
    }
    ...
    public function update($obj) {
        ...
        $stmt = Connexion::prepare("UPDATE " . self::$table . " SET date_emprunts=?, date_remise=?, id_emprunteur=?, id_exemplaire=? WHERE id_emprunts=? ; ");
