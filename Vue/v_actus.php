...
<!--            <script type="text/javascript">
        ...
        <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;visibility:hidden;">
            ...
            <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;">
                ...
                <div>
                    <a id="evenement" href="index.php?uc=evenement&action=affichageEven&id=<?php echo $lesEvenements[0]->getIdEvenement(); ?>"><img data-u="image" src="<?php echo $lesEvenements[0]->getLienImage(); ?>"></a>
                </div>
                <div>
                    <a id="evenement" href="index.php?uc=evenement&action=affichageEven&id=<?php echo $lesEvenements[1]->getIdEvenement(); ?>"><img data-u="image" src="<?php echo $lesEvenements[1]->getLienImage(); ?>" /></a>
                </div>
                <div>
                    <a id="evenement" href="index.php?uc=evenement&action=affichageEven&id=<?php echo $lesEvenements[2]->getIdEvenement(); ?>"><img data-u="image" src="<?php echo $lesEvenements[2]->getLienImage(); ?>" /></a>
                </div>
                <div>
                    <a id="evenement" href="index.php?uc=evenement&action=affichageEven&id=<?php echo $lesEvenements[3]->getIdEvenement(); ?>"><img data-u="image" src="<?php echo $lesEvenements[3]->getLienImage(); ?>" /></a>
                </div> 
            </div>
